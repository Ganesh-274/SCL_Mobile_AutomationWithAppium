...
function disableClipboard() {
    exec('adb shell service call clipboard 1', (err, stdout, stderr) => {
        if (err) {
...
exports.config = {
    ...
    specs: [
        ...
        // './test/specs/**/*.js'
        // './test/specs/ordersdynamic.spec.js'
        // './test/specs/Login.spec.js'
            // './test/specs/salesperformance.spec.js',
            './test/specs/SCL_002_Plan New Journey_DO_DJP_New Counter.spec.js',
            // './test/specs/profile.spec.js'
            // './test/specs/ordersmoduletestcases.spec.js',
            // './test/specs/OrdersTSM.spec.js'
            // './test/specs/brandingtestcase.spec.js'
    ],
    // Patterns to exclude.
    exclude: [
    ...
    capabilities: [{
        ...
        // app\android\UdaanPro_S2_06Mar_2035_Ver1.1.7+273.apk
        'appium:app': path.join(process.cwd(), 'app/android/UdaanPro_S1_ver1.1.28+530_SalesPlanning 1.apk')
    }],
